namespace ICSharpCode.AvalonEdit.Edi.Intellisense
{
  ...
  public class CompletionWindowResolver : ICompletionWindowResolver
    ...
    /// <param name="textEditor"></param>
		public CompletionWindowResolver(TextEditor textEditor,string input)
		{
			//_text = text;
			//_position = position;
			_input = input;
    ...
    /// <returns></returns>
		public CompletionWindow Resolve()
		{
            ...
            var cdata = _dataProviders.SelectMany(x => x.GetData(_target.Text, _target.CaretOffset, _input, hiName)).ToList();
