...
namespace ICSharpCode.AvalonEdit.Indentation.CSharp
{
	...
	sealed class IndentationReformatter
	{
		...
		public void Reformat(DocumentAccessor doc, IndentationSettings set)
		{
			Init();
		...
		public void Step(DocumentAccessor doc, IndentationSettings set)
		{
		...
		static bool TrimEnd(DocumentAccessor doc)
		{
			string line = doc.Text;
