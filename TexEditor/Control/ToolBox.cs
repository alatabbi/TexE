    ...
    protected override CreateParams CreateParams
    {
      get
      {
        ...
        private void drawRootItem(DrawTreeNodeEventArgs e)
        {
          ...
          {
              using (LinearGradientBrush lgBrush = new LinearGradientBrush(e.Bounds, Color.FromArgb(221, 220, 203), Color.FromArgb(196, 193, 176), LinearGradientMode.Vertical))
              {
          ...
          {
              e.Graphics.DrawImage(ATABBI.TexE.Properties.Resources.expanded, new Point(nodeTextRect.Left + 3, nodeTextRect.Top + 4));
          }
          else
          {
              e.Graphics.DrawImage(ATABBI.TexE.Properties.Resources.collapsed, new Point(nodeTextRect.Left + 3, nodeTextRect.Top + 4));
          }
        ...
        private void drawItem(DrawTreeNodeEventArgs e)
        {
          ...
          else
          {
            ...
            else
            {
                ...
                if (this.ImageList != null && e.Node.ImageIndex < this.ImageList.Images.Count)
                {
                    ControlPaint.DrawImageDisabled(e.Graphics, this.ImageList.Images[e.Node.ImageIndex],e.Bounds.Left + 3, e.Bounds.Top + 2, this.BackColor);
                }
        ...
        /// <summary>
        /// Handles the lost focus event of the edit text box.
        /// 
